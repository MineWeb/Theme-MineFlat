                                ...
                                <table class="table table-responsive">
                                    <tbody>
                                        <?php foreach ($configs as $config): ?>
                                            <tr>
                                                <td><?= $Lang->get($config['RCEonfig']['lang']); ?></td>
                                                <td><input type="radio" name="<?= $config['RCEonfig']['config_name']; ?>" <?php if($config['RCEonfig']['config_value'] == 1) echo "checked"; ?>value="1"> <?= $Lang->get('GLOBAL__ENABLED'); ?></td>
                                                <td><input type="radio" name="<?= $config['RCEonfig']['config_name']; ?>" <?php if($config['RCEonfig']['config_value'] == 0) echo "checked"; ?>value="0"> <?= $Lang->get('GLOBAL__DISABLED'); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
